...
<title>
  <?= $name_website ?> <?php if (isset($_SESSION['project_deo_gratias_farma']['name_page'])) {
                          if (!empty($_SESSION['project_deo_gratias_farma']['name_page'])) {
                            echo " - " . $_SESSION['project_deo_gratias_farma']['name_page'];
                          }
                        } ?>
</title>
