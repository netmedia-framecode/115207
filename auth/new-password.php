...
$_SESSION["project_deo_gratias_farma"]["name_page"] = "Reset Password";
            ...
            <div class="p-5">
              ...
              <form method="post">
                <div class="form-group">
                  <input type="email" name="email" value="<?= $data_account['email'] ?>" class="form-control form-control-user" id="email" placeholder="Email" readonly>
                </div>
                <div class="form-group">
